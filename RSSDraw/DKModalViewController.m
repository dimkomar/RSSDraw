...
-(id)init:(NSString *) param{
    ...
    if(self) {
        ...
        if([param isEqualToString:@"1"]){
            self.setModalViewPresentation = @"1";
            NSLog(@"%@ - value is",_setModalViewPresentation);
        } else if ([param isEqualToString:@"2"]){
            self.setModalViewPresentation = @"2";
            NSLog(@"%@ - value is",_setModalViewPresentation);
        }
...
- (void)viewDidLoad {
    ...
    //palette
    self.setModalViewPresentation = @"2";
    if ([self.setModalViewPresentation isEqualToString:@"1"]){
    ...
    //timer
    else if ([self.setModalViewPresentation isEqualToString:@"2"]){
       ...
       // UIFont * customFont = [UIFont fontWithName:ProximaNovaSemibold size:12]; //custom font
        ...
        minValue.adjustsLetterSpacingToFitWidth = YES;
        ...
        maxValue.adjustsLetterSpacingToFitWidth = YES;
        ...
        self.resultValue.adjustsLetterSpacingToFitWidth = YES;
